    ...
    <>
        ...
        <Layout>
          <section className="home h-full w-full">
            ...
            <div className="banner-container  opacity-100 w-full h-auto bg-[#F0F0F0] flex flex-wrap justify-around items-center text-center p-4">
              <div className="w-1/2 md:w-auto flex flex-col mb-4 md:mb-0">
                <span className="text-[30px] md:text-5xl  font-bold leading-[36px]">
                  $10Bn
                </span>
              ...
              <div className="w-1/2 md:w-auto flex flex-col mb-4 md:mb-0">
                <span className="text-[30px] md:text-5xl  font-bold leading-[36px]">80%</span>
                <span className="text-[14px] md:text-[18px] text-[#353B5B] pt-2">
              ...
              <div className="w-1/2 md:w-auto flex flex-col mb-4 md:mb-0">
                <span className="text-[30px] md:text-5xl  font-bold leading-[36px]">200X</span>
                <span className="text-[14px] md:text-[18px] text-[#353B5B] pt-2">
                  Return on
              ...
              <div className="w-1/2 md:w-auto flex flex-col">
                <span className="text-[30px] md:text-5xl  font-bold leading-[36px] mb-2">
                  $250Mn+
                </span>
          ...
          <section className="slider w-full py-8 bg-[#F0F0F0]">
            <div className="flex flex-col items-center text-center justify-center">
              <h2 className="text-[#0F0F0F] text-[48px] mb-6 font-bold md:font-bold">
          ...
          <section className="events w-full  bg-[#F0F0F0] ">
            <div className=" w-full md:w-[98vw]  bg-[#FFFFFF] py-10 bord rounded-tr-[100px] md:rounded-tr-[270px] ">
              <h1 className="text-[48px] font-bold md:font-bold leading-[60px] text-[#0F0F0F] flex justify-center items-center py-4">
                Events
              </h1>
          ...
          <section className="team w-full h-auto bg-gray-600/10 py-10">
            <div className="team_up flex  flex-col md:flex-row justify-center items-center text-center px-10">
              <div
                id="career"
                className="team_up_left  w-full font-bold text-[48px] leading-[60px] mb-4md:mb-[0px"
              >
                Become Part <br />
                of Our Team
              </div>
              <div className="team_up_right font-normal text-[14px] md:text-[18px] leading-8 text-[#5F5F5F] pb-[170px] md:py-12 text-left">
                Meet our people, see where we work and join a diverse, dynamic
                and growing organization that continually invests in advancing
                your skills and professional opportunities.
              </div>
            </div>
          ...
          <section className="connected w-full h-auto ">
            <div className="connected-class w-full h-auto flex flex-col justify-between items-center py-20">
              <h1 className="text-[#0F0F0F]  text-[35px] md:text-[48px] font-bold md:font-bold text-center leading-[33px] md:leading-[60px]">
              ...
              <p className="text-[#5F5F5F]md:text-[#556987] font-[500px] text-[14px] md:text-[18px] leading-[24px] md:leading-[30px] text-center py-6">
                It's never been easier to get in touch with Rits Capital. Call
                us, use our live chat widget or email and we'll get back to{" "}
              ...
              <div className="mapdesec w-full h-auto flex flex-col-reverse md:flex-row justify-evenly items-center  lg:px-[80px]">
                ...
                <div className="mapdesec_left w-full md:w-[35%] mb-6 md:mb-0 gap-3">
              ...
              <div className="investor_left flex-1 p-5 flex flex-col items-start justify-center ml-0 md:ml-[55px] relative z-10">
                ...
                >
                  <div className="mt-4 flex items-center ml-0 md:ml-[30px]">
                    <button className="flex items-center font-lato text-[16px] font-semibold leading-[19.2px] text-left border-2 text-white py-2 px-4 rounded ">
                      <FontAwesomeIcon
                        icon={faWhatsapp}
