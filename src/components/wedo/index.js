...
const WhatweDo = () => {
  ...
  return (
    <>
      <section
        className="what-we-do h-auto flex justify-center items-center py-4"
        id="what-we-do"
      >
        <div className="what-we-do-container  flex flex-col justify-center items-center">
          <div className="top-container flex flex-col justify-center items-center text-center py-4">
            <h2 className=" flex items-center leading-[30px] md:leading-[60px] font-lato md:text-[48px] md:text-[#0F0F0F] font-bold text-[48px] text-center py-3 ">
              What We do
            </h2>

            <p className="leading-6 text-[12px] md:text-[18px] font-normal text-[#5F5F5F] text-center pb-[20px]">
              Discover a range of services designed to meet your unique
              financial goals.
            </p>
          </div>
          <div><MobiWeDo /></div>
          <div className="hidden md:flex  bottom-container flex flex-col md:flex-row w-full md:w-[90vw] h-auto justify-evenly  rounded-tr-[100px] rounded-bl-[80px] py-16 mb-8">
