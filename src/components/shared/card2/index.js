    ...
    <div className=" justify-start items-center border-none ">
      ...
      >
          ...
          <div className="whatwedo_img relative h-[400px] md:h-[400px]  w-full md:w-[350px] ">
            <Image
              className="whtwedo_img2 md:ml-[-50px] md:mt-[30px] md:mr-[-16px]  "  
              src={currentImage}  
              alt="What We Do 1"
              layout="fill"
            //   objectFit="cover"
      ...
      {showWhatsAppIcon && (
        ...
        >
          <button className="btn btn-success w-full md:w-[200px] text-sm whitespace-nowrap mt-[15px] md:mt-[1px] md:ml-[140px] py-2.5">
